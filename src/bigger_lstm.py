...
# Assuming the 'set' column has values 'train', 'val', 'test'
data_train = data[data['set'] == 'train']
data_val = data[data['set'] == 'val']
data_test = data[data['set'] == 'test']

# Assuming the sequence length is still defined as before
...
"""
Original Matrics: {'MSE': 0.00010176627802138682, 'RMSE': 0.010087927340211508, 'MAE': 0.004163855420691627}
Metrics rescaled to original units:

MSE: 0.0006288187551390361
RMSE: 0.025076258794705323
MAE: 0.010350383442671649
"""
